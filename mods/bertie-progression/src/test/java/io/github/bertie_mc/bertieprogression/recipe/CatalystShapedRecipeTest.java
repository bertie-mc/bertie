...
class CatalystShapedRecipeTest {
    ...
    void catalystReturnsOneItemWhileOrdinaryInputsAreConsumed() {
        ...
        ShapedRecipePattern pattern =
                ShapedRecipePattern.of(Map.of('c', catalyst, 'i', Ingredient.of(Items.STICK)), "ci");
        CatalystShapedRecipe recipe = new CatalystShapedRecipe(
                "", CraftingBookCategory.MISC, pattern, new ItemStack(Items.MAP), true, catalyst);
        CraftingInput input =
                CraftingInput.of(2, 1, List.of(new ItemStack(Items.DIAMOND, 4), new ItemStack(Items.STICK, 2)));
