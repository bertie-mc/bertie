...
public final class ModAttachments {
     ...
     */
    public static final Supplier<AttachmentType<Boolean>> CRAFTING_LICENSED = ATTACHMENTS.register(
            "crafting_licensed",
     ...
     */
    public static final Supplier<AttachmentType<Integer>> ALLAY_DOOM = ATTACHMENTS.register(
            "allay_doom",
            () -> AttachmentType.builder(() -> 0).serialize(Codec.INT).build());

    /** Ticks of lava a Netherly Meal eater must still survive before Fire Resistance lands. */
    public static final Supplier<AttachmentType<Integer>> MEAL_COUNTDOWN = ATTACHMENTS.register(
            "meal_countdown",
            () -> AttachmentType.builder(() -> 0).serialize(Codec.INT).build());
     ...
     */
    public static final Supplier<AttachmentType<Boolean>> NETHER_UNLOCKED = ATTACHMENTS.register(
            "nether_unlocked",
            () -> AttachmentType.builder(() -> Boolean.FALSE)
                    .serialize(Codec.BOOL)
                    .copyOnDeath()
