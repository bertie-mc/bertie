package io.github.bertie_mc.bertie_progression.gate;

import io.github.bertie_mc.bertie_progression.ModAttachments;
...
/**
 * Current 3x3 gate: a vanilla Crafting Table only opens for a player who has consumed a Crafting
 * License ({@link io.github.bertie_mc.bertie_progression.item.CraftingLicenseItem}). Structure/loot tables stay
    ...
    public static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
        ...
        if (!level.isClientSide) {
            player.displayClientMessage(
                    Component.translatable("message.bertie_progression.table_unlicensed"), true);
        }
    }
