#!/usr/bin/env python3
"""
bertieprogression texture generator — original procedural 16x16 pixel art.
...
TEX_BLOCK = os.path.join(ROOT, "src", "main", "resources", "assets", "bertieprogression", "textures", "block")
