...
public final class RealSuperMartijn642ConfigTest {
    ...
    public static final String FILE_NAME = ConfigMigrationsClientTestMod.MOD_ID + "-" + CONFIG_NAME + ".toml";
    ...
    public static void register() {
        IConfigBuilder builder = ConfigBuilders.newTomlConfig(ConfigMigrationsClientTestMod.MOD_ID, CONFIG_NAME, false);
        migratedValue = builder.define("migratedValue", 1, Integer.MIN_VALUE, Integer.MAX_VALUE);
        builder.build();
    }
