...
The three 16x16 item sprites follow Minecraft Java 1.21.1's vanilla apple outline,
...
- Skeleton: ivory ribs joined to a central bone, with three pairs of open air gaps
...
Built-in ImageGen supplied revised concepts. `apple-prompts-v2.json` records the exact
prompts. `build-apple-textures.ps1` performs native-grid cleanup without downscaling;
