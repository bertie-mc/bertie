...
public class NucleeperModel extends AdvancedEntityModel<NucleeperEntity> {
    ...
    public void setupAnim(
        ...
        rleg.rotationPointY +=
                Math.min(0, walkValue(limbSwing, limbSwingAmount, walkSpeed, -0.5F, 5F, false)) - bodyBob;
        ...
        rleg2.rotationPointY +=
                Math.min(0, walkValue(limbSwing, limbSwingAmount, walkSpeed, -0.5F, 5F, true)) - bodyBob;
        ...
        if (look != null) {
            ...
            Vec3 vector3d3 = (new Vec3(vector3d1.x - vector3d.x, 0.0D, vector3d1.z - vector3d.z))
                    .normalize()
