...
public class HullbreakerModel extends AdvancedEntityModel<HullbreakerEntity> {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(
                root, body, body2, tail, head, tail, tail2, tail3, dorsal, dorsal2, jaw, rbarb, rbarb2, rbarbLure,
                lbarb, lbarb2, lbarbLure, teeth1, teeth2, teeth3, teeth4, teeth5, rflipper, lflipper);
    }
