...
public class SmallExplosionParticle extends TextureSheetParticle {
    ...
    protected SmallExplosionParticle(
        ...
        this.setColor(
                Math.min(FastColor.ARGB32.red(color1) / 255F + randCol, 1),
                Math.min(1F, FastColor.ARGB32.green(color1) / 255F + randCol),
                Math.min(1F, FastColor.ARGB32.blue(color1) / 255F + randCol));
    }
    ...
    public static class NukeFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
            ...
            SmallExplosionParticle particle =
                    new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, false, 0XFFB300);
    ...
    public static class MineFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double zSpeed) {
            SmallExplosionParticle particle =
                    new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, true, 0XFFB300);
            particle.setSpriteFromAge(spriteSet);
            return particle;
        }
    }
    ...
    public static class UnderzealotFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double zSpeed) {
            SmallExplosionParticle particle =
                    new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, false, 0);
            particle.setSpriteFromAge(spriteSet);
            return particle;
        }
    }
    ...
    public static class RaygunFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double zSpeed) {
            SmallExplosionParticle particle =
                    new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, true, 0XEEEEEE);
            particle.setSpriteFromAge(spriteSet);
    ...
    public static class AmberFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double zSpeed) {
            SmallExplosionParticle particle =
                    new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, false, 0XFFDA1E);
            particle.setSpriteFromAge(spriteSet);
            particle.scale(0.8F);
            return particle;
        }
    ...
    public static class TotemFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double zSpeed) {
            SmallExplosionParticle particle =
                    new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, true, 0XFF0000);
            particle.setSpriteFromAge(spriteSet);
            particle.lifetime = 5 + worldIn.random.nextInt(3);
    ...
    public static class PurpleWitchFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double zSpeed) {
            SmallExplosionParticle particle =
                    new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, true, 0XFF69FF);
            particle.setSpriteFromAge(spriteSet);
            particle.scale(0.8F);
    ...
    public static class ConversionCrucibleFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double ySpeed,
                double zSpeed) {
            SmallExplosionParticle particle = new SmallExplosionParticle(
                    worldIn,
                    x,
                    y,
                    z,
                    ...
                    spriteSet,
                    true,
                    FastColor.ARGB32.color(255, (int) (255F * xSpeed), (int) (255F * ySpeed), (int) (255F * zSpeed)));
            particle.setSpriteFromAge(spriteSet);
            particle.scale(0.8F);
            particle.setFadeColor(0XFFFFFF);
            return particle;
    ...
    public static class FrostmintFactory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double zSpeed) {
            SmallExplosionParticle particle =
                    new SmallExplosionParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet, true, 0XFFFFFF);
