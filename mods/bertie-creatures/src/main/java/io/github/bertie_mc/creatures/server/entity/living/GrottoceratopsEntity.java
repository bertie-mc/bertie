...
public class GrottoceratopsEntity extends DinosaurEntity implements IAnimatedEntity {
    ...
    private static final EntityDataAccessor<Float> TAIL_SWING_ROT =
            SynchedEntityData.defineId(GrottoceratopsEntity.class, EntityDataSerializers.FLOAT);
    ...
    public void tick() {
        ...
        if (this.getAnimation() == ANIMATION_CHEW && this.getAnimationTick() == 2
                || this.getAnimation() == ANIMATION_CHEW_FROM_GROUND && this.getAnimationTick() == 10) {
        ...
        if (this.getAnimation() == ANIMATION_SPEAK_1 && this.getAnimationTick() == 5
                || this.getAnimation() == ANIMATION_SPEAK_2 && this.getAnimationTick() == 2) {
    ...
    public Animation[] getAnimations() {
        return new Animation[] {
            ANIMATION_SPEAK_1,
            ANIMATION_SPEAK_2,
            ANIMATION_CHEW_FROM_GROUND,
            ANIMATION_CHEW,
            ANIMATION_MELEE_RAM,
            ANIMATION_MELEE_TAIL_1,
            ANIMATION_MELEE_TAIL_2
        };
    }
