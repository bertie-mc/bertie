...
public class DeepOneMageModel extends AdvancedEntityModel<DeepOneMageEntity> implements ArmedModel {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(
                ...
                bigTentaclerightBack,
                bigTentacleleftBack,
                bigTentacleleftFront,
                bigTentaclerightArm,
                bigTentacleleftArm,
                fin,
                bTendrilLeft,
    ...
    public void animate(IAnimatedEntity entity) {
        ...
        animator.rotate(bigTentacleleftArm, (float) Math.toRadians(-10), (float) Math.toRadians(-10), (float)
                Math.toRadians(-85));
        animator.rotate(bigTentaclerightArm, (float) Math.toRadians(-10), (float) Math.toRadians(10), (float)
                Math.toRadians(85));
        animator.endKeyframe();
        animator.startKeyframe(5);
        animator.rotate(body, (float) Math.toRadians(15), 0, 0);
    ...
    private void animatePose(int pose) {
        if (pose == 0) {
            ...
            animator.rotate(bigTentacleleftArm, (float) Math.toRadians(50), (float) Math.toRadians(40), (float)
                    Math.toRadians(65));
            animator.rotate(bigTentaclerightArm, (float) Math.toRadians(50), (float) Math.toRadians(-40), (float)
                    Math.toRadians(-65));
        }
    }
    ...
    public void setupAnim(
        ...
        progressRotationPrev(
                body, limbSwingAmount, (float) Math.toRadians(20 + 20 * entity.getSwimAmount(partialTicks)), 0, 0, 1F);
        ...
        if (look != null) {
            ...
            this.eye.rotateAngleX = (float)
                            Math.toRadians(Mth.wrapDegrees((float) ((Mth.atan2(d1, d3) * 180.0F / (float) Math.PI))))
                    + body.rotateAngleX;
