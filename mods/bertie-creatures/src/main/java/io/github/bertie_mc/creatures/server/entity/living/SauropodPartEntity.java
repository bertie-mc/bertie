...
public class SauropodPartEntity extends PartEntity<SauropodBaseEntity> {
    ...
    public boolean isInvulnerableTo(DamageSource damageSource) {
        ...
        return super.isInvulnerableTo(damageSource)
                ...
                || damageSource.getEntity() != null
                        && this.getParent().isPassengerOfSameVehicle(damageSource.getEntity());
    }
    ...
    public boolean hurt(DamageSource source, float amount) {
        ...
        if (parent == null || isInvulnerableTo(source)) return false;
        if (source.is(DamageTypeTags.IS_PROJECTILE)) amount *= 0.33F;
