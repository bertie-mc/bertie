...
public class StunStarParticle extends AbstractTrailParticle {
    ...
    private static final ResourceLocation CENTER_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(BertieCreatures.MODID, "textures/particle/stun_star.png");
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float partialTick) {
        ...
        VertexConsumer vertexconsumer =
                multibuffersource$buffersource.getBuffer(RenderType.entityTranslucentEmissive(CENTER_TEXTURE));
        ...
        vertexconsumer
                .addVertex(avector3f[0].x(), avector3f[0].y(), avector3f[0].z())
                .setColor(red, green, blue, alphaI)
                .setUv(f8, f6)
                .setOverlay(NO_OVERLAY)
                .setUv2(j & 0xFFFF, j >> 16)
                .setNormal(posestack$pose, -1.0F, 0.0F, 0.0F);
        vertexconsumer
                .addVertex(avector3f[1].x(), avector3f[1].y(), avector3f[1].z())
                .setColor(red, green, blue, alphaI)
                .setUv(f8, f5)
                .setOverlay(NO_OVERLAY)
                .setUv2(j & 0xFFFF, j >> 16)
                .setNormal(posestack$pose, -1.0F, 0.0F, 0.0F);
        vertexconsumer
                .addVertex(avector3f[2].x(), avector3f[2].y(), avector3f[2].z())
                .setColor(red, green, blue, alphaI)
                .setUv(f7, f5)
                .setOverlay(NO_OVERLAY)
                .setUv2(j & 0xFFFF, j >> 16)
                .setNormal(posestack$pose, -1.0F, 0.0F, 0.0F);
        vertexconsumer
                .addVertex(avector3f[3].x(), avector3f[3].y(), avector3f[3].z())
                .setColor(red, green, blue, alphaI)
                .setUv(f7, f6)
                .setOverlay(NO_OVERLAY)
                .setUv2(j & 0xFFFF, j >> 16)
        ...
        if (entity != null) {
            ...
            if (entity instanceof SauropodBaseEntity sauropod) {
                ...
                eyes = entity.getEyePosition()
                        .add(entity.getViewVector(0.0F).scale(entity.getBbWidth() * 0.85F))
                        .add(0, 0.5 + 0.12 * entity.getBbHeight(), 0);
                orbitOffset = new Vec3(0, 0, entity.getBbWidth() * 0.5F + 0.2F)
