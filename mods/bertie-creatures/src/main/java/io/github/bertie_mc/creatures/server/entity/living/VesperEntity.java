...
import io.github.bertie_mc.creatures.server.entity.ai.FlightPathNavigatorNoSpin;
import io.github.bertie_mc.creatures.server.entity.ai.VesperAttackGoal;
import io.github.bertie_mc.creatures.server.entity.ai.VesperFlyAndHangGoal;
import io.github.bertie_mc.creatures.server.entity.ai.VesperTargetUnderneathEntities;
import io.github.bertie_mc.creatures.server.entity.util.UnderzealotSacrifice;
...
public class VesperEntity extends Monster implements IAnimatedEntity, UnderzealotSacrifice {
            ...
            if (this.isHanging()) {
                ...
                if (validHangingPos) {
                    this.setDeltaMovement(
                            this.getDeltaMovement().multiply(0.1F, 0.3F, 0.1F).add(0, 0.08D, 0));
                } else {
                    this.setHanging(false);
                    this.setFlying(true);
                }
    ...
    public static boolean checkVesperSpawnRules(
    ...
    class MoveController extends MoveControl {
        ...
        public void tick() {
            if (this.operation == MoveControl.Operation.MOVE_TO) {
                ...
                parentEntity.setDeltaMovement(parentEntity
                        .getDeltaMovement()
                        .add(vector3d1)
                        .scale(0.95D)
                        .add(0, -0.01, 0));
