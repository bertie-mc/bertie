...
public class VoronoiGenerator {
    ...
    public VoronoiInfo get2(double x, double z, long seedParam) {
        ...
        return new VoronoiInfo(
                distanceType.getDistance(distance0),
                distanceType.getDistance(distance1),
                closestHash * (1 / 2147483648.0D),
                new Vec3(cellPosX, 0, cellPosZ),
                new Vec3(localPosX, 0, localPosZ));
    }
    ...
    public VoronoiInfo get3(double x, double y, double z) {
        ...
        double cellularJitter = 0.39614353f * offsetAmount;
        ...
        for (int xi = xr - 1; xi <= xr + 1; xi++) {
            ...
            for (int yi = yr - 1; yi <= yr + 1; yi++) {
                ...
                for (int zi = zr - 1; zi <= zr + 1; zi++) {
                    ...
                    Vec3 cell = new Vec3(
                            xi + RandVecs3D[idx] * cellularJitter,
                            yi + RandVecs3D[idx | 1] * cellularJitter,
                            zi + RandVecs3D[idx | 2] * cellularJitter);
