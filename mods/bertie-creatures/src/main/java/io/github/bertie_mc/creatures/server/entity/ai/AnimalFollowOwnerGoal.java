...
public abstract class AnimalFollowOwnerGoal extends FollowOwnerGoal {
    ...
    public AnimalFollowOwnerGoal(
            TamableAnimal tameable, double speed, float minDist, float maxDist, boolean teleportToLeaves) {
    ...
    private boolean isInCombat() {
        ...
        if (owner != null) {
            return tameable.distanceTo(owner) < 30
                    && tameable.getTarget() != null
                    && tameable.getTarget().isAlive();
        }
        return false;
    }
}
