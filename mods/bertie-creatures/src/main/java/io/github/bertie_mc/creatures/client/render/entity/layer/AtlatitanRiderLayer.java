...
import io.github.bertie_mc.creatures.client.render.entity.AtlatitanRenderer;
    ...
    public void render(
        ...
        if (entity.isVehicle()) {
            ...
            if (entity.getAnimation() == AtlatitanEntity.ANIMATION_STOMP) {
                animationIntensity = ACMath.cullAnimationTick(
                        entity.getAnimationTick(), 1F, AtlatitanEntity.ANIMATION_STOMP, partialTicks, 0, 30);
            }
            ...
            for (Entity passenger : entity.getPassengers()) {
                ...
                BertieCreatures.PROXY.releaseRenderingEntity(passenger.getUUID());
                poseStack.pushPose();
                ...
                poseStack.popPose();
                BertieCreatures.PROXY.blockRenderingEntity(passenger.getUUID());
            }
        }
    }
