...
import io.github.bertie_mc.creatures.server.block.DinosaurEggBlock;
    ...
    public void tick() {
        ...
        if (this.isReachedTarget()) {
            ...
            if (this.layEggCounter++ > this.maxTime) {
                ...
                if (this.mob instanceof DinosaurEntity dinosaur
                        && level.getBlockState(this.blockPos).is(BlockTags.DIRT)) {
