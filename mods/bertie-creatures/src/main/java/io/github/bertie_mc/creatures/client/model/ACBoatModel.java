...
public abstract class ACBoatModel extends AdvancedEntityModel<Boat> {
    ...
    public void setupPaddleAnims(
            Boat boat, AdvancedModelBox leftPaddle, AdvancedModelBox rightPaddle, float partialTicks) {
    ...
    private static void animatePaddle(Boat boat, int i, AdvancedModelBox paddle, float partialTicks) {
        ...
        paddle.rotateAngleY = f1
                * Mth.clampedLerp((-(float) Math.PI / 4F), ((float) Math.PI / 4F), (Mth.sin(-f + 1.0F) + 1.0F) / 2.0F);
    }
}
