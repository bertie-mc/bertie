...
import io.github.bertie_mc.creatures.client.model.WaterBoltModel;
...
public class WaterBoltRenderer extends EntityRenderer<WaterBoltEntity> {
    ...
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(BertieCreatures.MODID, "textures/entity/deep_one/water_bolt.png");
    private static final ResourceLocation OVERLAY_TEXTURE = ResourceLocation.fromNamespaceAndPath(
            BertieCreatures.MODID, "textures/entity/deep_one/water_bolt_overlay.png");
    private static final WaterBoltModel MODEL = new WaterBoltModel();
    private static final ResourceLocation TRAIL_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(BertieCreatures.MODID, "textures/particle/trail.png");
    ...
    private void renderTrail(
        ...
        while (samples < sampleSize) {
            ...
            vertexconsumer
                    ...
                    .setColor(trailR, trailG, trailB, trailA)
                    .setUv(u1, 1F)
