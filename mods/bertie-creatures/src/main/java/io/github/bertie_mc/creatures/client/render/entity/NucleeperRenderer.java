...
import io.github.bertie_mc.creatures.client.render.entity.layer.NucleeperEnergySwirlLayer;
...
public class NucleeperRenderer extends MobRenderer<NucleeperEntity, NucleeperModel> {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(BertieCreatures.MODID, "textures/entity/nucleeper/nucleeper.png");
    private static final ResourceLocation TEXTURE_GLOW = ResourceLocation.fromNamespaceAndPath(
            BertieCreatures.MODID, "textures/entity/nucleeper/nucleeper_glow.png");
    private static final ResourceLocation TEXTURE_GLASS = ResourceLocation.fromNamespaceAndPath(
            BertieCreatures.MODID, "textures/entity/nucleeper/nucleeper_glass.png");
    private static final ResourceLocation TEXTURE_BUTTONS_0 = ResourceLocation.fromNamespaceAndPath(
            BertieCreatures.MODID, "textures/entity/nucleeper/nucleeper_buttons_0.png");
    private static final ResourceLocation TEXTURE_BUTTONS_1 = ResourceLocation.fromNamespaceAndPath(
            BertieCreatures.MODID, "textures/entity/nucleeper/nucleeper_buttons_1.png");
    private static final ResourceLocation TEXTURE_BUTTONS_2 = ResourceLocation.fromNamespaceAndPath(
            BertieCreatures.MODID, "textures/entity/nucleeper/nucleeper_buttons_2.png");
    private static final ResourceLocation TEXTURE_EXPLODE = ResourceLocation.fromNamespaceAndPath(
            BertieCreatures.MODID, "textures/entity/nucleeper/nucleeper_explode.png");
    ...
    private static void shineOriginVertex(
            VertexConsumer p_114220_, Matrix4f p_114221_, PoseStack.Pose pose, float xOffset, float yOffset) {
        p_114220_
                .addVertex(p_114221_, 0.0F, 0.0F, 0.0F)
                .setColor(0, 255, 0, 230)
    ...
    private static void shineLeftCornerVertex(
            VertexConsumer p_114215_,
            Matrix4f p_114216_,
            PoseStack.Pose pose,
            float p_114217_,
            float p_114218_,
            ...
            float yOffset) {
        p_114215_
                .addVertex(p_114216_, -ACMath.HALF_SQRT_3 * p_114218_, p_114217_, 0)
                .setColor(0, 255, 0, 0)
                .setUv(xOffset, yOffset + 1)
                .setOverlay(NO_OVERLAY)
                .setLight(240)
                .setNormal(pose, 0.0F, -1.0F, 0.0F);
    }

    private static void shineRightCornerVertex(
            VertexConsumer p_114224_,
            Matrix4f p_114225_,
            PoseStack.Pose pose,
            float p_114226_,
            float p_114227_,
            ...
            float yOffset) {
        p_114224_
                .addVertex(p_114225_, ACMath.HALF_SQRT_3 * p_114227_, p_114226_, 0)
                .setColor(0, 255, 0, 0)
                .setUv(xOffset + 1, yOffset + 1)
                .setOverlay(NO_OVERLAY)
                .setLight(240)
                .setNormal(pose, 0.0F, -1.0F, 0.0F);
    }
    ...
    class LayerGlow extends RenderLayer<NucleeperEntity, NucleeperModel> {
        ...
        public void render(
                ...
                MultiBufferSource bufferIn,
                int packedLightIn,
                NucleeperEntity entitylivingbaseIn,
                float limbSwing,
