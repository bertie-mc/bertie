...
public class LuxtructosaurusSpitParticle extends TextureSheetParticle {
    ...
    protected LuxtructosaurusSpitParticle(
    ...
    public void setInMouthPos(float partialTick) {
        if (luxtructosaurusId != -1 && level.getEntity(luxtructosaurusId) instanceof LuxtructosaurusEntity entity) {
            ...
            if (mouthPos != null) {
                Vec3 translate = mouthPos.add(inMouthOffset)
                        .yRot((float) (Math.PI - entity.yBodyRot * ((float) Math.PI / 180F)));
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(
                ...
                double ySpeed,
                double zSpeed) {
            LuxtructosaurusSpitParticle particle =
                    new LuxtructosaurusSpitParticle(worldIn, x, y, z, (int) xSpeed, spriteSet);
            return particle;
        }
    }
}
