...
public class VesperModel extends AdvancedEntityModel<VesperEntity> {
    ...
    public Iterable<AdvancedModelBox> getAllParts() {
        return ImmutableList.of(
                root, head, nose, jaw, tail, torso, lleg, rleg, lfoot, rfoot, lear, rear, lwing, lwingTip, lfinger,
                rwing, rwingTip, rfinger, cube_r1, cube_r2, cube_r3, cube_r4, cube_r5, cube_r6, cube_r7, cube_r8,
                cube_r9, cube_r10, cube_r11, cube_r12, cube_r13, cube_r14);
    }
    ...
    public void setupAnim(
        ...
        progressRotationPrev(
                root, sleepProgress, 0, 0, (float) Math.toRadians(180 * (entity.getId() % 2 == 0 ? -1 : 1)), 1F);
