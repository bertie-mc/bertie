...
import io.github.bertie_mc.creatures.client.model.AtlatitanModel;
import io.github.bertie_mc.creatures.client.render.ACRenderTypes;
import io.github.bertie_mc.creatures.client.render.entity.layer.AtlatitanRiderLayer;
...
public class AtlatitanRenderer extends MobRenderer<AtlatitanEntity, AtlatitanModel>
        implements CustomBookEntityRenderer {
    private static final ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(BertieCreatures.MODID, "textures/entity/atlatitan.png");
    private static final ResourceLocation TEXTURE_RETRO =
            ResourceLocation.fromNamespaceAndPath(BertieCreatures.MODID, "textures/entity/atlatitan_retro.png");
    private static final ResourceLocation TEXTURE_TECTONIC =
            ResourceLocation.fromNamespaceAndPath(BertieCreatures.MODID, "textures/entity/atlatitan_tectonic.png");
