...
import io.github.bertie_mc.creatures.client.model.ACBoatChestModel;
import io.github.bertie_mc.creatures.client.model.ACBoatModel;
import io.github.bertie_mc.creatures.client.model.ThornwoodBoatModel;
...
public class AlexsCavesBoatRenderer<T extends Boat & AlexsCavesBoat> extends EntityRenderer<T> {
    ...
    private static final ResourceLocation CHEST_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(BertieCreatures.MODID, "textures/entity/boat/chest.png");
        ...
        for (AlexsCavesBoat.Type type : AlexsCavesBoat.Type.values()) {
            textureMap.put(
                    ...
                    ResourceLocation.fromNamespaceAndPath(
                            BertieCreatures.MODID, "textures/entity/boat/" + type.getName() + "_boat.png"));
        }
    ...
    public void render(
        ...
        if (!Mth.equal(f2, 0.0F)) {
            poseStack.mulPose((new Quaternionf())
                    .setAngleAxis(entity.getBubbleAngle(partialTicks) * ((float) Math.PI / 180F), 1.0F, 0.0F, 1.0F));
        }
        ...
        if (isChest) {
            ...
            CHEST_MODEL.renderToBuffer(
                    poseStack,
                    bufferIn.getBuffer(RenderType.entityCutoutNoCull(CHEST_TEXTURE)),
                    packedLightIn,
