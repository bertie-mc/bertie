...
| `depth.fullDepth` | `0` | blocks above the floor where it is at full strength |
...
| `appearance.fogEnd` | `14.0` | distance where it is solid; lower is thicker |
| `appearance.darkness` | `0.92` | how far the colour is pulled to black; 1.0 is pitch black |
