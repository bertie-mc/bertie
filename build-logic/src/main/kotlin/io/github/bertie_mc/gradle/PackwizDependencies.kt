...
import io.github.bertie_mc.gradle.tasks.PackwizArtifact
import io.github.bertie_mc.gradle.tasks.PackwizProvider
...
fun Project.packagingClasspath(
    name: String,
...
fun Configuration.externalPackwizArtifacts(
    selectedArtifacts: Provider<List<MinecraftArtifact>>,
...
fun Configuration.ownedPackFiles(): FileCollection = incoming.artifactView {
