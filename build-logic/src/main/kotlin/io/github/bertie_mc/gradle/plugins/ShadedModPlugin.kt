...
class ShadedModPlugin : Plugin<Project> {
    ...
    private fun configure(project: Project) =
        with(project) {
            ...
            val prepareDevelopmentLibraries =
                tasks.register<Sync>("prepareShadedDevelopmentLibraries") {
