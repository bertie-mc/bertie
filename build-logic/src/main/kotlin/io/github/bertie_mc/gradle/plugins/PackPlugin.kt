...
class PackPlugin : Plugin<Project> {
    override fun apply(project: Project) = with(project) {
        ...
        val packMods = configurations.dependencyScope("packMods") {
        ...
        val gameTestRuntimeMods = configurations.dependencyScope("gametestRuntimeMods") {
            extendsFrom(packMods.get())
        }
        val clientTestRuntimeMods = configurations.dependencyScope("clienttestRuntimeMods") {
            extendsFrom(packMods.get())
        }
        ...
        val shaderpackPackagingArtifacts = packagingClasspath(
    ...
    ): Configuration = configurations.resolvable(name) {
